                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-50">
                                                <h4 class="card-title mb-0">Dashboard <span
                                                    class="break-320-480-none">Edit Admin</span></h4>
                                                    <div class="d-flex">
                                                        <a href="{{ route('admin.user.index') }}" class="btn btn-danger btn-sm mr-2">Kembali</a>
                                                    </div>
                                            </div>
                                            ...
                                            <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('id') is-invalid @enderror" id="id" name="id" value="{{ $user->id }}" disabled>
                                                    @error('id')
