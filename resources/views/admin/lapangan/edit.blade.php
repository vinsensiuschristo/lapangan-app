                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('admin.lapangan.update', $lapangan->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('id') is-invalid @enderror" id="id" name="id" value="{{ $lapangan->id }}">
                                                    @error('id')
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ $lapangan->nama }}">
                                                    @error('nama')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select id="kategori" class="form-control" class="@error('kategori') is-invalid @enderror" name="kategori">
                                                        <option selected>Pilih -</option>
                                                        @foreach ($kategoris as $kategori)
                                                            <option value="{{ $kategori->id }}" {{ $kategori->id == $lapangan->kategori_id ? 'selected' : ''}}>{{ $kategori->nama }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('kategori')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control @error('foto1') is-invalid @enderror" type="file" id="formFile" name="foto1">
                                                    @error('foto1')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control @error('foto2') is-invalid @enderror" type="file" id="formFile2" name="foto2">
                                                    @error('foto2')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control @error('foto3') is-invalid @enderror" type="file" id="formFile3" name="foto3">
                                                    @error('foto3')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" max="10000000" value="{{ $lapangan->harga }}">
                                                    @error('harga')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
