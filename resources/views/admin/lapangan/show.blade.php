                ...
                <div class="side-menu-area">
                    ...
                    <nav>
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="active"><a href="{{ route('admin.lapangan.index') }}"><i class='fa fa-futbol-o'></i><span>Menu Lapangan</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-50">
                                                <h4 class="card-title mb-0">Dashboard <span
                                                    class="break-320-480-none">Input Lapangan</span></h4>
                                                    <div class="d-flex">
                                                        <a href="{{ route('admin.lapangan.index') }}" class="btn btn-danger btn-sm mr-2">Kembali</a>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">ID Lapangan</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        <span class="profile-info">{{ $lapangan->id }}</span>
                                                    </div>
                                                </div>
                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">Nama Lapangan</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        <span class="profile-info">{{ $lapangan->nama }}</span>
                                                    </div>
                                                </div>
                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">Kategori Lapangan</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        <span class="profile-info">{{ $lapangan->nama_kategori }}</span>
                                                    </div>
                                                </div>
                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">Harga Lapangan</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        <span class="profile-info">RP. {{ $lapangan->harga }}</span>
                                                    </div>
                                                </div>

                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">Foto 1</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        <img src="{{ asset('storage/foto-lapangan/'.$lapangan->foto) }}" style="width: 200px; height:200px;" alt="">
                                                    </div>
                                                </div>

                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">Foto 2</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        @if ($lapangan->foto2 == null)
                                                            <span class="profile-info">Tidak ada foto</span>
                                                        @else
                                                        <img src="{{ asset('storage/foto-lapangan/'.$lapangan->foto2) }}" style="width: 200px; height:200px;" alt="">
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row profile-row">
                                                    <div class="col-xs-5 col-sm-3">
                                                        <span class="profile-cat">Foto 3</span>
                                                    </div>
                                                    <div class="col-xl-7 col-sm-9">
                                                        @if ($lapangan->foto3 == null)
                                                            <span class="profile-info">Tidak ada foto</span>
                                                        @else
                                                        <img src="{{ asset('storage/foto-lapangan/'.$lapangan->foto3) }}" style="width: 200px; height:200px;" alt="">
                                                        @endif
                                                    </div>
                                                </div>
