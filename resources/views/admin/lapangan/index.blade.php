                                ...
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex">
                                                <a href="{{ route('admin.lapangan.create') }}" class="btn btn-primary btn-sm mr-2">Tambah Lapangan</a>
                                            </div>
                                            </div>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    @foreach($lapangans as $lapangan)
                                                        <tr>
                                                            <td>{{ $lapangan->id }}</td>
                                                            <td>{{ $lapangan->nama_kategori }}</td>
                                                            <td>{{ $lapangan->nama }}</td>
                                                            <td><img src="{{ asset('storage/foto-lapangan/'.$lapangan->foto) }}" style="width: 200px; height:200px;"></td>
                                                            <th>
                                                                <a href="{{ route('admin.lapangan.show', $lapangan->id) }}" class="action-item mr-2" data-bs-toggle="tooltip" title="Show">
                                                                    <i class="fa fa-eye"></i>
                                                                    </a>
                                                                <a href="{{ route('admin.lapangan.edit', $lapangan->id) }}" class="action-item mr-2" data-bs-toggle="tooltip" title="Edit">
